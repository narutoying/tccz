 ...
 * @version $Id: CrmResult.java, v 0.1 2013-3-4 下午8:53:07 narutoying09@gmail.com
 *          Exp $
 */
public class CommonResult implements Serializable {
	 ...
	 *            结果描述信息
	 */
	public CommonResult(boolean isSuccess, String resultCode,
	 ...
	 * 
	 * @param isSuccess
	 *            value to be assigned to property isSuccess
	 */
	 ...
	 * 
	 * @param resultMessage
	 *            value to be assigned to property resultMessage
	 */
	 ...
	 *            结果信息
	 */
	public static void buildResult(CommonResult result, boolean isSuccess,
